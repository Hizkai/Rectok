...
def parse_dataset_args(parser):
    ...
    parser.add_argument("--train_data_sample_num", type=str, default="0")
...
def load_datasets(args):
    train_datasets = []
    dataset = SeqRecDataset(args, mode="train", prompt_sample_num=int(args.train_prompt_sample_num), sample_num=int(args.train_data_sample_num))
